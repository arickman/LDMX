...
os.system("mv ENpionMult.root /nfs/slac/g/ldmx/production/arickman")
...
hist2.Draw()
c1.SaveAs("/nfs/slac/g/ldmx/production/arickman/ENprotonMult.root")
...
#hist2.SetFillStyle(3025)
hist3.Draw()
c1.SaveAs("/nfs/slac/g/ldmx/production/arickman/ENneutronMult.root")
...
#hist2.SetFillStyle(3025)
hist4.Draw()
c1.SaveAs("/nfs/slac/g/ldmx/production/arickman/ENhardChargedMult.root")
...
#hist2.SetFillStyle(3025)
hist5.Draw()
c1.SaveAs("/nfs/slac/g/ldmx/production/arickman/ENhardPionMult.root")
