...
hist.Draw()
c1.SaveAs("/u/ey/arickman/ldmx/production/arickman/ENpionMult.root")
...
hist2.Draw()
c1.SaveAs("/u/ey/arickman/ldmx/production/arickman/ENprotonMult.root")
...
#hist2.SetFillStyle(3025)
hist3.Draw()
c1.SaveAs("/u/ey/arickman/ldmx/production/arickman/ENneutronMult.root")
...
#hist2.SetFillStyle(3025)
hist4.Draw()
c1.SaveAs("/u/ey/arickman/ldmx/production/arickman/ENhardChargedMult.root")
...
#hist2.SetFillStyle(3025)
hist5.Draw()
c1.SaveAs("/u/ey/arickman/ldmx/production/arickman/ENhardPionMult.root")
