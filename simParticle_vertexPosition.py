...
hist = TH1D('Electron EndPoint Momentum', 'Electron EndPoint Momentum', 10, 0, 5000)
fill_hist(hist, eVec)
...
hist2 = TH1D('Positron EndPoint Momentum', 'Positron EndPoint Momentum', 10, 0, 5000)
fill_hist(hist2, posVec)
hist2.SetLineColor(r.kRed)
myLegend.AddEntry(hist2, "Positron", "L")
hist2.Draw("same")

hist3 = TH1D('Gamma EndPoint Momentum', 'Gamma EndPoint Momentum', 10, 0, 5000)
