/**
 * @file ENTargetProcessFilter.cxx
...
namespace ldmx { 
    ...
    G4ClassificationOfNewTrack TargetProcessFilter::stackingClassifyNewTrack(
        ...
        if (track == currentTrack_) {
            ...
            //std::cout << "[ TargetFilter ]: Pushing track to waiting stack." << std::endl;
            return fWaiting; 
        }
    ...
    void TargetProcessFilter::stepping(const G4Step* step) { 
        ...
        if (secondaries->size() == 0) {
            ...
            //was the only brem track and didn't produce any daughters--no PN reaction.
            ...
            std::cout << "[ TargetProcessFilter ]: "
                      ...
                      << " particles via an" << processName << " process." 
                      << std::endl;
